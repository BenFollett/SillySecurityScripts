#Hi is a variable with the string 'hi' in it.
#This is what we will use to say "hi" in our print statement below
hi = "hi"

#print statement saying "hi" to the user. this statement uses an F-string. 
